...
const PowerStructure = require('./PowerStructure');

// https://en.wikipedia.org/wiki/Government

class DistributedFormalInvisibleFluid extends PowerStructure {
	constructor() {
		super();
		// this._name = name; // Separatism / Federalism / Supranationalism.. these aren't right..

		this._distribution = 1; // float from 0 to 1, with 1 being uniform distribution?
		...
		*/
		this._formality = 1; // float from 0 to 1, with 1 being complete formality?
		...
		*/
		this._fluidity = 1; // float from 0 to 1, with 1 being total fluidity?
...
module.exports = DistributedFormalInvisibleFluid;